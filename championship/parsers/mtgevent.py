...
from .general_parser_functions import record_to_points, find_index_with_substring
...
def _standings(soup):
    ...
    player_index = find_index_with_substring(titles, ["Player"])
    record_index = find_index_with_substring(titles, ["Record"])
